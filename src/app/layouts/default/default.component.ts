...
import { ILayout, LayoutType } from 'src/app/layouts/default/core/configs/config';
import { LayoutInitService } from 'src/app/layouts/default/core/layout-init.service';
import { LayoutService } from 'src/app/layouts/default/core/layout.service';
import { IPageInfo } from 'src/app/shared/models/page-info.model';


export const GlobalArea = 1;
@Component({
  selector: 'app-default[class="d-flex flex-column flex-root"]',
...
export class DefaultComponent implements OnInit {
  ...
  constructor(
    ...
    // document.querySelector('app-root').id = 'kt_app_root';
    // document.querySelector('app-root').className = 'd-flex flex-column flex-root';
